...
description: Analyze version-specific Lethal Company mechanics from decompiled assemblies, Unity assets, seeded RNG, and runtime observations, then produce reproducible evidence-backed reports. Use for mechanics investigations, efficient resumable full-seed enumeration, additive reuse of sealed enumerations, code/asset reconciliation, Terminal or HUD behavior, version comparisons, statistical prediction, or when code defaults may be overridden by serialized assets.
---
...
7. Preserve scripts, locks, evidence, raw/intermediate/processed data, review records, and reproduction commands with the deliverable.
