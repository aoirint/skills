...
| [local-model-agent-workflow](.apm/skills/local-model-agent-workflow/README.md) | Use local language and vision-language models as bounded, verifiable agent assistants. |
